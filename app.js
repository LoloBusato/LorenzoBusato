...
//-------------------------------------------------------------------//
let inicioSubtituloEs = "Desarrollador Full Stack";
let inicioSubtituloEn = "Full Stack Developer";
let aboutTituloEs = "¡Hola mundo!";
let aboutTituloEn = "Hello world!";
let aboutInformacionEs = "Me llamo Lorenzo Busato, tengo 20 años y vivo en Buenos Aires, Argentina. Soy técnico en electrónica y me encuentro estudiando la carrera de licenciatura en análisis de sistemas. Además, soy programador autodidacta, actualmente enfocado en BackEnd, y adquiriendo nuevos conocimientos día a día.</br>Este es mi sitio web que refleja mis habilidades actuales. Bienvenidos!";
let aboutInformacionEn = "My name is Lorenzo Busato, I am 20 years old and I live in Buenos Aires, Argentina. I am an Electronics Technician and I am studying for a bachelor degree in Systems Analysis. Also, I am a self-taught programmer, currently focused on BackEnd, and acquiring new knowledge day by day.<br />This is my portfolio reflecting my current skills. Welcome!";
